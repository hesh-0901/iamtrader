...
function mount(modal){
 ...
 script.type='text/javascript';script.src=TV;script.async=true;
...
function run(){document.querySelectorAll('.modal .menu-modal').forEach(m=>{if(m.querySelector('.v13-chart'))mount(m)})}
