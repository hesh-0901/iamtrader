...
<nav class="lp-navlinks"><a href="#features">Fonctionnalités</a><a href="#method">Méthode</a><a href="#plans">Plans</a><a href="#propfirm">Prop Firm</a></nav>
<div class="lp-nav-actions"><button class="lp-btn ghost" data-register="free">Se connecter</button><button class="lp-btn primary" data-register="free">Commencer gratuitement</button></div>
</header>
<main>
...
<div class="lp-hero-actions"><button class="lp-btn primary large" data-register="free">Commencer gratuitement →</button><a class="lp-btn ghost large" href="#features">Découvrir la plateforme</a></div>
...
<section class="lp-plans" id="plans"><div class="lp-container"><div class="lp-section-head"><span class="lp-eyebrow">CHOISISSEZ VOTRE ACCÈS</span><h2>Un plan pour chaque parcours.</h2><p>Commencez gratuitement ou activez l'accès complet. Les membres de la communauté bénéficient d'un tarif dédié après approbation.</p></div><div class="lp-plan-grid">
<article class="lp-plan"><span class="lp-plan-kicker">POUR DÉCOUVRIR</span><h3>Free</h3><div class="lp-plan-price"><b>0 $</b><span>/ toujours</span></div><div class="lp-plan-note">Accès gratuit aux fonctionnalités disponibles.</div><ul class="lp-plan-list"><li>Profil trader</li><li>Fonctionnalités gratuites</li><li>Évolution vers un plan supérieur</li></ul><button class="lp-btn ghost" data-register="free">Créer mon compte</button></article>
<article class="lp-plan featured"><span class="lp-plan-badge">PRO</span><span class="lp-plan-kicker">POUR TRADER SÉRIEUSEMENT</span><h3>Pro</h3><div class="lp-plan-price"><b>5 $</b><span>/ mois</span></div><div class="lp-plan-note">Durée choisie lors de l'inscription.</div><ul class="lp-plan-list"><li>Gestion des comptes et trades</li><li>Risk Manager</li><li>Performance Analytics</li><li>Trader Score et psychologie</li><li>Trading Plan et Prop Firm</li></ul><button class="lp-btn primary" data-register="pro">Choisir Pro</button></article>
<article class="lp-plan"><span class="lp-plan-kicker">POUR LA COMMUNAUTÉ</span><h3>Community</h3><div class="lp-plan-price"><b>20 $</b><span>/ 6 mois</span></div><div class="lp-plan-note">Tarif réservé aux membres approuvés.</div><ul class="lp-plan-list"><li>Tout le contenu Pro</li><li>6 mois d'accès</li><li>Tarif communautaire</li><li>Code membre délivré par l'Admin</li></ul><button class="lp-btn dark" data-register="community">Demander l'accès</button></article>
</div><p class="lp-community-note">Le code membre est créé et délivré uniquement par l'administration après approbation de la demande.</p></div></section>\n<section class="lp-section soft" id="method"><div class="lp-container"><div class="lp-section-head"><span class="lp-eyebrow">VOTRE BOUCLE DE PROGRESSION</span><h2>Préparer. Trader. Comprendre. Progresser.</h2><p>IAMTRADER accompagne le trader dans le temps, au lieu de simplement stocker ses opérations.</p></div><div class="lp-flow">
...
document.querySelectorAll('[data-register="free"]').forEach(b=>b.addEventListener('click',()=>{location.hash='app';location.reload()}));
}
